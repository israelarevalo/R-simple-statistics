...
If you are importing a natively supported datatype such as `.csv`, feel free to skip the following sections and navigate to the (Importing CSV files into R) section of this tutorial.
