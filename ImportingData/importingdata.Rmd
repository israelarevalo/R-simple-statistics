...
Of important note, if you are importing a natively supported datatype such as `.csv`, [click here](#importing-csv-files-into-r) to skip the following sections and navigate to the (Importing CSV files into R) section of this tutorial.
